class Public::HomesController < ApplicationController
  ...
  def top
    ...
    when 'good'
      ...
      @posts = Kaminari.paginate_array(@posts.includes(:favorites).sort {|a,b| b.favorites.size <=> a.favorites.size}).page(params[:page])
      ...
      #配列がからむ時は、Kaminari.paginate_arrayをつける必要がある
    when 'old'
